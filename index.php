...
<!-- TRAVAIL PIERRE -->
<div class="navsticky hidden-xs">
    <nav class="navbar navbar-default nav-transparent-b">
        <div class="container-fluid">
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="navbar-header">
                <!-- Burger Button -->
            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav text-center blink nav-b">
                    <li><a href="#"><span onclick="$.scrollify.move('#steven');"># ACCUEIL</span></a></li>
                    <li><a href="#"><span onclick="$.scrollify.move('#pierre');"># JEUX</span></a></li>
                    <li><a href="#"><span onclick="$.scrollify.move('#paul');"># SNACKING-BAR</span></a></li>
                    <li><a href="#"># INFOS PRATIQUES</a></li>
...
<script src="js/Scrollify/app.js" type="text/javascript"></script>
